...
import { LayoutDashboard, Target, Image as ImageIcon, FlaskConical, Lightbulb, Bell, Settings, ActivitySquare, CheckSquare, Globe, Search, Eye, BrainCircuit, History, Calculator, Shield, LogOut, BarChart2 } from 'lucide-react';
